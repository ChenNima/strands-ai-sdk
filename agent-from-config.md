...
*   `model`: Model identifier (string) - \[[Only supports AWS Bedrock model provider string](about:blank/quickstart/#using-a-string-model-id)\]
...
*   `**kwargs`: Additional [Agent constructor parameters](about:blank/api-reference/agent/#strands.agent.agent.Agent.__init__) that override config values
